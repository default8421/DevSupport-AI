...
const PATTERNS: { re: RegExp; color: string; bg: string }[] = [
  { re: /req_[0-9a-zA-Z_]+/g, color: "#0f766e", bg: "#ccfbf1" },
  { re: /\/v\d+\/[A-Za-z0-9/_-]+/g, color: "#531dab", bg: "#f9f0ff" },
  { re: /\b[A-Z][A-Z0-9]*_[A-Z0-9_]+\b/g, color: "#ad4e00", bg: "#fff7e6" },
  { re: /\b[1-5]\d{2}\b/g, color: "#cf1322", bg: "#fff1f0" },
];
